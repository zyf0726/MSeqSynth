...
public class DllLauncher {
	...
	private static void init() throws ClassNotFoundException {
		cls$List = Class.forName("examples.sushi.dll.LinkedList");
		cls$Entry = Class.forName("examples.sushi.dll.LinkedList$Entry");
		cls$Iter = Class.forName("examples.sushi.dll.LinkedList$ListItr");
		cls$DesIter = Class.forName("examples.sushi.dll.LinkedList$DescendingIterator");
	}
